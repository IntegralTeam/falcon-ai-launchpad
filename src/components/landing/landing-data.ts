...
export const LANDING_SECTIONS = [
  ...
  { id: "who", label: "Audience" },
  { id: "trust", label: "Trust" },
  { id: "enroll", label: "Enroll" },
  { id: "faq", label: "FAQ" },
] as const;

export const CHAOS_CAPABILITY_ROWS = [
  {
    chaos: "Random tool experiments",
    capability: "Fundamentals → Tools → Agents → Strategy",
  },
  {
    chaos: "Unclear data boundaries",
    capability: "Verification checklists and data safety rules",
  },
  {
    chaos: "Hours re-checking outputs",
    capability: "Readiness Brief, Tool Portfolio, Roadmap",
  },
  {
    chaos: "No governance",
    capability: "Human-in-the-loop design across every workflow",
  },
] as const;
...
export const COURSES = [
  {
    ...
    tagline: "Understand AI before you choose tools.",
    artifact: "AI Use-Case Readiness Brief",
    image: courseFundamentalsImage,
    href: learnWorldsCourseUrls.aiFundamentals,
  },
  {
    id: "course-2",
    n: "02",
    title: "AI Tools & Practical Cases",
    tagline: "Move from AI understanding to practical tool use.",
    artifact: "AI Tool Testing Portfolio",
    image: courseToolsImage,
    href: learnWorldsCourseUrls.aiTools,
  },
  {
    id: "course-3",
    n: "03",
    title: "AI Agents & Automation",
    tagline: "Design AI workflows that do more than answer questions.",
    artifact: "Agentic Workflow Blueprint",
    image: courseAgentsImage,
    href: learnWorldsCourseUrls.aiAgents,
  },
  {
    id: "course-4",
    n: "04",
    title: "AI Strategy, Implementation & Operating Model",
    tagline: "Turn AI experiments into responsible business capability.",
    artifact: "AI Implementation Roadmap",
    image: courseStrategyImage,
    href: learnWorldsCourseUrls.aiStrategy,
  },
] as const;
...
export const TOOL_PORTFOLIO_ROWS = [
...
export const WORKFLOW_STEPS = ["User", "Agent", "Approval", "Action"] as const;
...
export const ARTIFACT_SHOWCASE = [
  {
    n: "01",
    title: "AI Use-Case Readiness Brief",
    hook: "Know if a workflow is ready for AI — before you spend a dirham.",
    accent: "var(--falcon-gold)",
    bg: "bg-falcon-sand",
  },
  {
    n: "02",
    title: "AI Tool Testing Portfolio",
    hook: "Compare tools against your real criteria — not marketing claims.",
  ...
  },
  {
    ...
    hook: "Design agents with approval gates — not runaway automation.",
  ...
  },
  {
    ...
    hook: "Move from pilot to scale with governance your leadership will sign.",
    accent: "var(--falcon-ink)",
    bg: "bg-falcon-sand",
  },
] as const;
...
export const PERSONAS = [
  {
    ...
    hook: "Stop funding random pilots",
    bg: "bg-falcon-green",
    text: "text-white",
    span: "sm:col-span-2",
  },
  {
    label: "Managers",
    hook: "Build team-wide AI capability",
    bg: "bg-falcon-ink",
    text: "text-white",
    span: "",
  },
  {
    label: "Consultants",
    hook: "Defend tool choices with evidence",
    bg: "bg-falcon-gold",
    text: "text-white",
    span: "",
  },
  {
    label: "Marketing",
    hook: "Create without losing brand control",
    bg: "bg-white",
    text: "text-falcon-ink",
    span: "",
  },
  {
    label: "Operations",
    hook: "Streamline workflows safely",
    bg: "bg-falcon-red",
    text: "text-white",
    span: "",
  },
  {
    label: "HR & People",
    hook: "Adopt AI in people processes",
    bg: "bg-falcon-sand",
    text: "text-falcon-ink",
    span: "sm:col-span-2",
  },
...
export const BENEFIT_GROUPS = [
  {
    ...
    tags: ["DEFEND TOOL CHOICES", "FASTER DELIVERY", "PROVE AI FLUENCY"],
    featured: false,
  },
  {
    ...
    tags: ["EVALUATION CRITERIA", "VERIFICATION STANDARDS", "PRODUCTIVITY LIFT"],
    featured: true,
  },
  {
    ...
    tags: ["BUILD VS BUY ROADMAP", "COMPLIANCE READY", "ACCOUNTABLE CAPABILITY"],
    featured: false,
  },
] as const;

export const COURSE1_READINESS_BRIEF = [
  { label: "Workflow", value: "Vendor contract review" },
  { label: "Data sensitivity", value: "Confidential — legal" },
...
export const TRUST_POINTS = [
  { label: "Educational licence", value: "No. 52001001", accent: "var(--falcon-gold)" },
  { label: "Registered entity", value: "Falcon Expert Institute FZ-LLC", accent: "var(--falcon-green)" },
  { label: "Structured outcomes", value: "Defined learning paths", accent: "var(--falcon-gold)" },
  { label: "UAE governance", value: "Standards of accountability", accent: "var(--falcon-green)" },
] as const;
...
export { learnWorldsAiFundamentalsUrl, learnWorldsCourseUrls };
export { learnWorldsCoursesUrl } from "@/lib/learnworlds";
